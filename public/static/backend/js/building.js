        ...
        index: function () {
            Table.init = {
                ...
                requests:{
                    ...
                    add_url:'Building/add'+location.search,
                    edit_url:'Building/edit'+location.search,
                    destroy_url:'Building/destroy'+location.search,
                    delete_url:'Building/delete'+location.search,
                    recycle_url:'Building/recycle'+location.search,
                    import_url:'Building/import'+location.search,
                    export_url:'Building/export'+location.search,
                    modify_url:'Building/modify'+location.search,
            ...
            Table.render({
                ...
                cols: [[
                    ...
                    {field:'acive', title: __('Acive'),align: 'center'},
        ...
        recycle: function () {
            Table.init = {
                ...
                requests: {
                    delete_url:'Building/delete'+location.search,
                    recycle_url:'Building/recycle'+location.search,
                    restore_url:'Building/restore'+location.search,
